...
class CustomDatePicker extends StatelessWidget {
  ...
  final DateTime? lastDate;  // Allows customization of the last selectable date
  ...
  const CustomDatePicker({
    ...
    this.lastDate,  // Initialize lastDate
  }) : super(key: key);
  ...
  void _selectDate(BuildContext context) async {
    ...
    final DateTime? pickedDate = await showDatePicker(
      ...
      lastDate: lastDate ?? DateTime(2101),   // Use lastDate if provided
