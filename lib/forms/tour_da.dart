...
ThemeData theme = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(
      ...
      backgroundColor: const Color(0xFF8A2724), // button text color
    ),
  ),
);
...
class _TourDaState extends State<TourDa> {
                ...
                children: [
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (data) {
                              setState(() {
                                ...
                                print("minetouur value${_minetour![0].datefrom}");
                              });
                            },
                          ),
                          onTap: () {
                  ...
                  GetBuilder<DaController>(
                      ...
                      builder: (daController) {
                        return daController.staffDetails == null
                            ? const SizedBox()
                            : ListView.builder(
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: daController.staffDetails.length,
                                shrinkWrap: true,
                                  ...
                                  return ListTile(
                                    ...
                                    subtitle: RichText(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(
                                            text: "No of Days: ${daController
                                                    .staffDetails[index].days}\n",
                                            style: textStyle),
                                        TextSpan(
                                            text: "No of Nights: ${daController
                                                    .staffDetails[index].nights}\n",
                                            style: textStyle),
                                        TextSpan(
                                            text: "Daily Allowance: ${daController
                                    ...
                                    trailing: IconButton(
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            daController.removeDa(daController
                                                .staffDetails[index]);
                  ...
                  return Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          child: Row(
                            children: [
                              Text('Total DA ₹: ${daController.grandDAList!}',
                                  style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white)),
                          ...
                          onPressed: () async {
                            ...
                            setState(() {
                              ...
                              daController.staffDetails.isEmpty
                                  ? _validateStaff = true
                            ...
                            if (!_validateTour &&
                              ...
                              print('Hello  ${daController.empName}');

                              var rsp = await insert_tourda(
                                  tourValue!,
                                  _fromController.text,
                                  _toController.text,
                                  daController.empName.toString(),
                                  daController.empFrom.toString(),
                                  daController.empTo.toString(),
                                  daController.empDays.toString(),
                                  daController.empNights.toString(),
                                  daController.empDa.toString(),
                                  daController.empRemark.toString(),
                                  daController.grandDAList!.toString(),
                                  GetStorage().read('username'));
                              if (rsp['status'].toString() == '1') {
                                isLoading.value = false;
                                daController.staffDetails.clear();
                                _fromController.clear();
                                _toController.clear();
                                daController.empName.clear();
                                daController.empFrom.clear();
                                daController.empTo.clear();
                                daController.empDays.clear();
                                daController.empNights.clear();
                                daController.empDa.clear();
                                daController.empRemark.clear();
                                daController
                                    .setTotalDa(daController.grandDAList!);
  ...
  Future insert_tourda(
    ...
    var response = await http
        .post(Uri.parse('${MyColors.baseUrl}insert_tour_da.php'), headers: {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  style: MyText.body2(context)!
                                      .copyWith(color: MyColors.grey_40),
                                  keyboardType: TextInputType.datetime,
                                  controller: daController.fromController,
                                  decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.all(-12),
                                      border: InputBorder.none,
                                      hintText: "Starting Date(yyyy-mm-dd)",
                              ...
                              IconButton(
                                  onPressed: () {
                                    daController.selectDate(context,
                                        daController.fromController, 'from');
                                  },
                                  icon: const Icon(Icons.calendar_today,
                                      color: MyColors.grey_40))
                            ],
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  style: MyText.body2(context)!
                                      .copyWith(color: MyColors.grey_40),
                                  keyboardType: TextInputType.datetime,
                                  controller: daController.toController,
                                  decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.all(-12),
                                      border: InputBorder.none,
                                      hintText: "Ending Date(yyyy-mm-dd)",
                              ...
                              IconButton(
                                  onPressed: () async {
                                    ...
                                    final birthday = DateFormat('yyyy-MM-dd')
                                        .parse(daController.toController.text);
                                    final date2 = DateFormat('yyyy-MM-dd')
                                        .parse(
                                            daController.fromController.text);
                                    final difference =
                                        birthday.difference(date2).inDays;

                                    daController.daysController.text =
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  style: MyText.body2(context)!
                                      .copyWith(color: MyColors.grey_40),
                                  keyboardType: TextInputType.datetime,
                                  controller: daController.daysController,
                                  decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.all(-12),
                                      border: InputBorder.none,
                                      hintText: "No of days",
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  //readOnly: true,
                                  onChanged: (value) {
                                    daController.totalEmpDaController.text =
                                  ...
                                  controller:
                                      daController.nightcountController,
                                  decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.all(-12),
                                      border: InputBorder.none,
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  keyboardType: TextInputType.datetime,
                                  controller:
                                      daController.totalEmpDaController,
                                  decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.all(-12),
                                      border: InputBorder.none,
                        ...
                        TextField(
                          ...
                          controller: daController.remark,
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                StaffDetails staff = StaffDetails(
                                  name: daController.staffName,
                                  from: daController.fromController.text,
                                  to: daController.toController.text,
                                  days: daController.daysController.text,
                                  nights:
                                      daController.nightcountController.text,
                                  empDa: double.parse(
                                      daController.totalEmpDaController.text),
                                  remark: daController.remark.text,
                                );

                                daController.addData(staff);
                                daController.addDA(double.parse(
                                    daController.totalEmpDaController.text));
                                daController.addName(daController.staffName!);
                                daController
                                    .addFrom(daController.fromController.text);
                                daController
                                    .addTo(daController.toController.text);
                                daController
                                    .addDays(daController.daysController.text);
                                daController.addNights(
                                    daController.nightcountController.text);
                                daController.addEmpDa(
                                    daController.totalEmpDaController.text);
                                daController
                                    .addRemark(daController.remark.text);
                                print("this is da");
